...
finishing, not reasoning.** GLM 5.2 has both problems.

The benchmark questions and answer key are third-party work (Rahnon / Mikaela Chowdhury, LBNL)
and are deliberately **not** included here. Only aggregate results are published.
